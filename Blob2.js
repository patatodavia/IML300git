...
function draw() {
  ...
  blobs.forEach((blob1, i) => {
    blobs.forEach((blob2, j) => {
      ...
      if (distance < maxDistance) {
        ...
        gradient.addColorStop(0, `rgba(0,255,127, ${strength * 0.6})`);
        gradient.addColorStop(1, "rgba(0,255,60, 0)");
  ...
  blobs.forEach((blob) => {
    ...
    outerGradient.addColorStop(0, `rgba(0, 255, 50, ${blob.opacity * 0.4})`);
    outerGradient.addColorStop(0.5, `rgba(0, 255, 40, ${blob.opacity * 0.2})`);
    outerGradient.addColorStop(1, "rgba(0, 255, 30, 0)");
    ...
    blobGradient.addColorStop(0, `rgba(90, 255, 90, ${blob.opacity})`);
    blobGradient.addColorStop(0.6, `rgba(50, 255, 50, ${blob.opacity * 0.95})`);
    blobGradient.addColorStop(1, `rgba(30, 200, 30, ${blob.opacity * 0.85})`);
